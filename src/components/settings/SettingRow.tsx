...
export const SettingRow: React.FC<SettingRowProps> = ({ item, isLast }) => {
  const content = (
    <View style={styles.row}>
      ...
      <Text
        style={[
          styles.rowLabel,
          item.destructive && { color: Colors.expenseRed },
        ]}
      >
        {item.label}
      </Text>
...
export const SettingGroup: React.FC<SettingGroupProps> = ({ title, rows }) => (
  <>
